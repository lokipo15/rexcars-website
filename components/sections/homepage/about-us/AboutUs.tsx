...
export default function AboutUs() {
    return (
        <section className='flex flex-col w-[80%] mx-auto mt-[8%]'>
            <h2 className='text-neutral-200 text-5xl text-right mb-8'>
                Firma prowadzona{' '}
                <span className='text-blue-primary font-semibold'>z Pasją</span>
            </h2>
            <div className='flex flex-row ease-in-out duration-300 bg-neutral-950 hover:bg-neutral-900 hover:scale-105 rounded-lg py-10 pl-16'>
                <Image
                ...
                <div className='text-2xl text-neutral-200 text-center h-full my-auto justify-center items-center'>
                    ...
                    <Button value='Zarezerwuj teraz' href='/zarezerwuj' styles='w-[85%] mx-auto text-2xl py-2'/>
                </div>
            </div>
        </section>
    );
