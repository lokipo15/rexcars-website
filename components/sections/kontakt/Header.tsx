...
export default function Header() {
    return (
        <div className="flex flex-col w-[80%] mx-auto justify-center md:pt-[5%] pt-[15%]">
            ...
            <p className="text-neutral-400 font-light md:text-base text-sm text-center md:pt-4 pt-2 md:max-w-[40%] max-w-[90%] mx-auto">Jeśli chcesz zarezewować jeden z naszych samochodów, zakupić voucher, lub uzyskać więcej informacji o usługach, które świadczymy, skontaktuj się z nami.</p>
